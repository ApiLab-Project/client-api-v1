...
export default function Testimonials() {
  return (
    <div id="testimonials" className="flex items-center justify-center w-full px-8 py-10 border-t md:py-16 lg:py-24 xl:py-40 xl:px-0">
        ...
        <div className="flex-col items-center ">
            <div className="flex flex-col items-center justify-center w-full h-full max-w-2xl pr-8 mx-auto text-center">
                <p className="my-5 text-base font-medium tracking-tight text-indigo-500 uppercase">
                    Nossos Usuários AMAM jogar e aprender!
                </p>
                ...
                <p className="my-6 text-xl font-medium text-gray-500">
                    Leia os comentários de quem realmente usa nossos serviços!
                </p>
                        ...
                        <div className="flex flex-col pr-8">
                            <div className="relative pl-12">
                                ...
                                <p className="mt-2 text-base text-gray-600">
                                    Achei o jogo interativo e divertido, sempre aproveito para fazer as revisões para o vestibular
                                </p>
                            </div>
                            ...
                            <h3 className="pl-12 mt-3 text-base font-medium leading-5 text-gray-800 truncate">
                                ...
                                <span className="mt-1 text-sm leading-5 text-gray-500 truncate">
                                    Aluna do Segundo Ano do Ensino Médio        
                                </span>
                            </h3>
                            <p className="mt-1 text-sm leading-5 text-gray-500 truncate"></p>
                        </div>
                        <img className="flex-shrink-0 object-cover w-24 h-24 mb-5 bg-gray-300 rounded-full md:mb-0" src="https://images.unsplash.com/photo-1544725176-7c40e5a71c5e?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=crop&amp;w=2694&amp;q=80" alt=""/>
                    </blockquote>
                    <blockquote className="flex flex-col-reverse items-center justify-between w-full col-span-1 p-6 mt-16 mb-16 text-center transition-all duration-200 bg-gray-100 rounded-lg md:flex-row md:text-left hover:bg-white hover:shadow ease xl:mb-0">
                        <div className="flex flex-col pr-10">
                            <div className="relative pl-12">
                                ...
                                <p className="mt-2 text-base text-gray-600">
                                    É muito melhor aprender de uma forma interativa!
                                </p>
                            </div>
                            <h3 className="pl-12 mt-3 text-base font-medium leading-5 text-gray-800 truncate">
                                Fabio Pedro Amaral
                        ...
                        <img className="flex-shrink-0 object-cover w-24 h-24 mb-5 bg-gray-300 rounded-full md:mb-0" src="https://images.unsplash.com/photo-1546820389-44d77e1f3b31?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=crop&amp;w=1400&amp;q=80" alt=""/>
                    </blockquote>
                </div>
                    ...
                    <blockquote className="flex flex-col-reverse items-center justify-between w-full col-span-1 p-6 text-center transition-all duration-200 bg-gray-100 rounded-lg md:flex-row md:text-left hover:bg-white hover:shadow ease">
                        <div className="flex flex-col pr-10">
                            <div className="relative pl-12">
                                ...
                                <p className="mt-2 text-base text-gray-600">
                                    Fiquei muito feliz dos professores poderem contribuir com informação e perguntas assim o jogo fica sempre atualizado!
                                </p>
                            </div>
                            <h3 className="pl-12 mt-3 text-base font-medium leading-5 text-gray-800 truncate">
                                Fabiano Moura
                                <br/>
                                <span className="mt-1 text-sm leading-5 text-gray-500 truncate">
                                    Professor de Ensino Médio de Biologia        
                                </span>
                            </h3>
                            <p className="mt-1 text-sm leading-5 text-gray-500 truncate"></p>
                        </div>
                        <img className="flex-shrink-0 object-cover w-24 h-24 mb-5 bg-gray-300 rounded-full md:mb-0" src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=crop&amp;w=1700&amp;q=80" alt=""/>
                    </blockquote>
                    <blockquote className="flex flex-col-reverse items-center justify-between w-full col-span-1 p-6 mt-16 text-center transition-all duration-200 bg-gray-100 rounded-lg md:flex-row md:text-left hover:bg-white hover:shadow ease">
                        <div className="flex flex-col pr-10">
                            <div className="relative pl-12">
                                ...
                                <p className="mt-2 text-base text-gray-600">
                                    Recomendamos a todos os alunos como complemento do conteúdo de aula.
                                </p>
                            </div>
                            <h3 className="pl-12 mt-3 text-base font-medium leading-5 text-gray-800 truncate">
                                Camilla Sanchez
                                <br/>
                                <span className="mt-1 text-sm leading-5 text-gray-500 truncate">
                                    Cordenadora Academica do Ensino Médio        
                                </span>
                            </h3>
                            <p className="mt-1 text-sm leading-5 text-gray-500 truncate"></p>
                        </div>
                        <img className="flex-shrink-0 object-cover w-24 h-24 mb-5 bg-gray-300 rounded-full md:mb-0" src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=crop&amp;w=2700&amp;q=80" alt=""/>
                    </blockquote>
                </div>
            </div>
