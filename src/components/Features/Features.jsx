import img01Community from './../../assets/images/img01Community.svg'
import img02Games from './../../assets/images/img02Games.svg'
import img03Card from './../../assets/images/img03Card.svg'

export default function Features() {
  return (
<div id="features" className="relative w-full px-8 py-10 border-t md:py-16 lg:py-24 xl:py-40 xl:px-0">
        <div className="container flex flex-col items-center justify-between h-full max-w-6xl mx-auto">
            ...
            <h3 className="max-w-2xl px-5 mt-2 text-3xl font-black leading-tight text-center text-gray-900 sm:mt-0 sm:px-0 sm:text-6xl">
                Valores que empoderam a mente !    
            </h3>
            <div className="flex flex-col w-full mt-0 lg:flex-row sm:mt-10 lg:mt-10">
                ...
                <div className="w-full max-w-md p-4 mx-auto mb-0 sm:mb-16 lg:mb-0 lg:w-1/3">
                    <div className="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
                        ...
                        <img className="relative w-20 h-20" viewBox="0 0 58 58" src={img01Community} alt="img comunidade"/>
                            <defs>
                        ...
                        <h4 className="relative mt-6 text-lg font-bold">LABCommunity</h4>
                        <p className="relative mt-2 text-base text-center text-gray-600">Criando fairplay e conhecimento entre jogadores</p>
                ...
                <div className="w-full max-w-md p-4 mx-auto mb-0 sm:mb-16 lg:mb-0 lg:w-1/3">
                    <div className="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
                        ...
                        <img className="relative w-20 h-20" viewBox="0 0 58 58" src={img02Games} alt="icon para jogos"/>
                            <defs>
                                ...
                                <filter x="-14%" y="-10%" width="128%" height="128%" filterUnits="objectBoundingBox" id="filter-3Icon2">
                                    <feOffset dy="2" in="SourceAlpha" result="shadowOffsetOuter1"></feOffset>
                                    <feGaussianBlur stdDeviation="2" in="shadowOffsetOuter1" result="shadowBlurOuter1"></feGaussianBlur>
                                    <feColorMatrix values="0 0 0 0 0.501960784 0 0 0 0 0.125490196 0 0 0 0 0 0 0 0 0.15 0" in="shadowBlurOuter1"></feColorMatrix>
                                </filter>
                                <path d="M17.947 0h14.106c6.24 0 8.503.65 10.785 1.87a12.721 12.721 0 015.292 5.292C49.35 9.444 50 11.707 50 17.947v14.106c0 6.24-.65 8.503-1.87 10.785a12.721 12.721 0 01-5.292 5.292C40.556 49.35 38.293 50 32.053 50H17.947c-6.24 0-8.503-.65-10.785-1.87a12.721 12.721 0 01-5.292-5.292C.65 40.556 0 38.293 0 32.053V17.947c0-6.24.65-8.503 1.87-10.785A12.721 12.721 0 017.162 1.87C9.444.65 11.707 0 17.947 0z" id="path-2Icon2"></path>
                            </defs>
                        ...
                        Criamos jogos atualmente com os temas de microbiologia, vacinas e imunologia para alunos do Ensino Medio
                        </p>
                ...
                <div className="w-full max-w-md p-4 mx-auto mb-16 lg:mb-0 lg:w-1/3">
                    <div className="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
                        ...
                        <img className="relative w-20 h-20" viewBox="0 0 58 58" src={img03Card} alt="icon cards"/>
                            <defs>
                                ...
                                <filter x="-14%" y="-10%" width="128%" height="128%" filterUnits="objectBoundingBox" id="filter-3Icon3">
                                    <feOffset dy="2" in="SourceAlpha" result="shadowOffsetOuter1"></feOffset>
                                    <feGaussianBlur stdDeviation="2" in="shadowOffsetOuter1" result="shadowBlurOuter1"></feGaussianBlur>
                                    <feColorMatrix values="0 0 0 0 0.031372549 0 0 0 0 0.149019608 0 0 0 0 0.658823529 0 0 0 0.15 0" in="shadowBlurOuter1"></feColorMatrix>
                                </filter>
                                <path d="M17.947 0h14.106c6.24 0 8.503.65 10.785 1.87a12.721 12.721 0 015.292 5.292C49.35 9.444 50 11.707 50 17.947v14.106c0 6.24-.65 8.503-1.87 10.785a12.721 12.721 0 01-5.292 5.292C40.556 49.35 38.293 50 32.053 50H17.947c-6.24 0-8.503-.65-10.785-1.87a12.721 12.721 0 01-5.292-5.292C.65 40.556 0 38.293 0 32.053V17.947c0-6.24.65-8.503 1.87-10.785A12.721 12.721 0 017.162 1.87C9.444.65 11.707 0 17.947 0z" id="path-2Icon3"></path>
                            </defs>
                            <g id="Page-1Icon3" str322oke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        ...
                                        <g id="Group-9-Copy-2Icon3" transform="translate(800 365)">
                                            <g id="Group-8Icon3" transform="translate(125)">
                                                <g id="Rectangle-9Icon3">
                                                    <use fill="#000" filter="url(#filter-3Icon3)" xlink:href="#path-2Icon3"></use>
                                                    <use fill="url(#linearGradient-1Icon3)" xlink:href="#path-2Icon3"></use>
                                                </g>
                                                <g id="smart-notificationsIcon3" transform="translate(15 11)" fill="#FFF" fill-rule="nonzero">
                                                    <path d="M12.519 3.243a6.808 6.808 0 00-.187 1.298h-8.44a2.595 2.595 0 00-2.595 2.594v12.973a2.595 2.595 0 002.595 2.595h12.973a2.595 2.595 0 002.594-2.595v-8.44c.445-.02.88-.084 1.298-.187v8.627A3.892 3.892 0 0116.865 24H3.892A3.892 3.892 0 010 20.108V7.135a3.892 3.892 0 013.892-3.892h8.627zm6.616 6.487a4.865 4.865 0 110-9.73 4.865 4.865 0 010 9.73z" id="IconIcon3"></path>
                                                </g>
                                            </g>
                                        </g>
                                    </g>
                        ...
                        <h4 className="relative mt-6 text-lg font-bold">LabCards</h4>
                        <p className="relative mt-2 text-base text-center text-gray-600">
                            Nossos jogadores podem usar os cards de conteudo para preparar-se para os jogos
                        </p>
                    </div>
                </div>
